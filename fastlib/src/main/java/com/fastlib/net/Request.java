...
public class Request{
    ...
    private long mSendEventInterval=1000; //上传和下载文件时发送广播事件间隔
    ...
    public Request setSendEventInterval(long interval){
        mSendEventInterval=interval;
        return this;
    }

    public long getSendEventInterval(){
        return mSendEventInterval;
    }
    ...
    public static class ExtraHeader {
        ...
        public static ExtraHeader create(boolean canDuplication, String field, String value){
            return new ExtraHeader(canDuplication,field,value);
        }
    }
}